...
// exit( " till here it work"); ----------------------------------------------------------------------------------------------------------------------------


// here I create the table if do not exist
try {
    
    $sqlCreateQuizTable = "CREATE TABLE IF NOT EXISTS `questions` (
      `id` int NOT NULL,
 ...
 $dbConnection->exec($sqlCreateQuizTable); 
...
try {  
    $sql = "INSERT INTO `questions` (`id`, `topic`, `question_text`, `answer_1`, `answer_2`, `answer_3`, `answer_4`, `answer_5`, `correct`) VALUES
    ...
    (109, 'werkzeuge', 'Welche Werkzeuge g // we pick the secuense of the qid question  from the data bankibt es wirklich?', 'Fuchsschwanz', 'Kneifzange', 'Tapetenschmeichler', 'Rotbrenner', 'Rotationszange', '1, 2'),
    ...
    (119, 'cinema', 'What is the title of  // we pick the secuense of the qid question  from the data bankn film and theater?', 'Actors', 'Screen', 'Story', 'Director', 'All of them', '1, 3, 4'),
